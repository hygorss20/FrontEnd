...
@Component({
  selector: "app-buy-firecape",
  templateUrl: "./buy-firecape.component.html",
  styleUrls: ["./buy-firecape.component.scss"],
  providers: [CurrencyPipe],
})
export class BuyFirecapeComponent implements OnInit {
  title: string = "";
  price: number;
  priceUSD: number;
  priceLabel: string = "";
