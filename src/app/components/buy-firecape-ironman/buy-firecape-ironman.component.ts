...
@Component({
  selector: "app-buy-firecape-ironman",
  templateUrl: "./buy-firecape-ironman.component.html",
  styleUrls: ["./buy-firecape-ironman.component.scss"],
  providers: [CurrencyPipe],
})
export class BuyFirecapeIronmanComponent implements OnInit {
  title: string = "";
  price: number;
  priceUSD: number;
  priceLabel: string = "";
